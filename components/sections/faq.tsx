      ...
      <ViewContainer className="my-36">
        <div className="faq-cta-content-container rounded-2xl overflow-hidden bg-gradient-to-b from-neutral-700 to-neutral-900 grid grid-cols-1 sm:grid-cols-2 border relative">
          <div className="faq-content-section px-10 pt-10 pb-16">
            <h1 className="faq-headline text-4xl sm:text-6xl font-semibold text-white leading-[68px] sm:left-12 bottom-12 sm:absolute mb-8">
              Elara Locks & <br />
              Home Fittings FAQs
            </h1>
            <p className="faq-description text-neutral-300 mt-4 max-w-xl text-lg sm:left-12 bottom-12 sm:absolute">
              Have questions about our products or services? We've got answers.
            </p>
          </div>
